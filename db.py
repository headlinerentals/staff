...
def restore_remote_backup_if_needed() -> bool:
    ...
    # Safety: never overwrite a non-empty local DB unless explicitly allowed.
    # This prevents valid deletions/edits from being resurrected by an older cloud backup.
    if local_rows > 0 and not bool(REMOTE_BACKUP_ALLOW_NONEMPTY_RESTORE):
        return False
