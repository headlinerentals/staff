...
def render_top_nav_bar(active_section: str) -> None:
    ...
    selected_section = st.radio(
        ...
        index=ordered_sections.index(active),
        horizontal=True,
        format_func=lambda section: section_label_map.get(section, section),
        label_visibility="collapsed",
    )
    if selected_section != active:
        st.session_state["nav_pending_section"] = selected_section
        st.rerun()
