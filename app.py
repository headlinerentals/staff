...
def render_invoices() -> None:
    ...
    with st.expander("Automatic fee rate settings", expanded=False):
        ...
        staff_pay_floor_hourly = rs5c.number_input(
            ...
            min_value=0.0,
            step=25.0,
            value=delivery_setting_float("staff_pay_floor_hourly", 687.50),
            ...
            help=(
                ...
                "reflects real Driver pay (J$500/hr-equivalent) plus 50% of the Assistant's (J$375/hr-equivalent), "
                "since both accompany every delivery run."
            ),
        )
        staff_pay_floor_daily = rs5d.number_input(
            ...
            min_value=0.0,
            step=250.0,
            value=delivery_setting_float("staff_pay_floor_daily", 5500.0),
            ...
            help=(
                ...
                "below this combined per-day rate. Default reflects real Driver pay (J$4,000/day) plus 50% of "
                "the Assistant's (J$3,000/day), since both accompany every delivery run."
            ),
        )
